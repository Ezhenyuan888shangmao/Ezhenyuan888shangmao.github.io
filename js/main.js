...
function renderAgeWarning() {
    ...
    for (let i = 0; i < count; i++) {
        ...
        leftHtml += `<div class="absolute bg-red-600 text-white text-sm font-bold py-2 px-1 rounded-r-lg transform -rotate-90 origin-center whitespace-nowrap" style="top: ${topPosition}px;">禁止未成年人购酒</div>`;
        rightHtml += `<div class="absolute bg-red-600 text-white text-sm font-bold py-2 px-1 rounded-l-lg transform rotate-90 origin-center whitespace-nowrap" style="top: ${topPosition}px;">禁止未成年人购酒</div>`;
    }
